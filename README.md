...
| ![정인](media/readme_jungin.jpeg) | [윤정인](https://github.com/KerasKorea/KEKOxTutorial.git) |유튜브 보기!|[케라스로 이해하는 Autoencoder](https://keraskorea.github.io/posts/2018-10-23-keras_autoencoder/) <br/>[Keras와 GPU-enabled Kaggle Kernel을 활용한 LSTM 텍스트 생성]()|
