...
나아가, 모델이 로컬 디바이스에서 내부적으로 동작하게 되면, 어플리케이션이 동작하기 위한 인터넷 연결이 필요없게 됩니다. 이때 EyeNet은 아주 유용하고 간편한 역할을 할 수 있습니다. 

## 참고자료

1. [당뇨망박병증이란?(영문))](http://www.mayoclinic.org/diseases-conditions/diabetic-retinopathy/basics/definition/con-20023311)
